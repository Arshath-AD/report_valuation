...
export default function Layout() {
  ...
  return (
    <div className="flex flex-col h-screen bg-leaves bg-cover bg-center bg-no-repeat bg-fixed transition-colors duration-200 relative overflow-hidden z-0">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden relative z-10 w-full">
        ...
        >
              ...
              filteredNavItems.map((item) => {
                ...
                return (
                  <NavLink
                    ...
                    ${isActive
                        ? 'bg-white/15 backdrop-blur-sm shadow-lg shadow-brand-950/20 border border-white/20 text-white dark:text-white dark:bg-white/15'
          ...
          {/* Footer Sidebar */}
          <div className="p-4 border-t border-white/10 bg-black/20 rounded-b-[calc(1.5rem-1px)]">
