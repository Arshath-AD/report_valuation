    ...
    return (
        <div>
            <div className="flex flex-col gap-2 mb-8">
                ...
                <p className="text-white/80">Manage your team members and their permissions.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="group bg-slate-800/40 rounded-2xl border border-slate-700/50 p-6 shadow-xl hover:shadow-brand-500/10 transition-all duration-500 relative overflow-hidden flex items-center justify-between isolate">
                    <div>
                ...
                <div className="group bg-slate-800/40 rounded-2xl border border-slate-700/50 p-6 shadow-xl hover:shadow-brand-500/10 transition-all duration-500 relative overflow-hidden flex items-center justify-between isolate">
                    <div>
                        ...
                        <p className="text-3xl font-bold text-white">{rolesCount}</p>
                    </div>
                ...
                <div className="group bg-slate-800/40 rounded-2xl border border-slate-700/50 p-6 shadow-xl hover:shadow-brand-500/10 transition-all duration-500 relative overflow-hidden flex items-center justify-between isolate">
                    <div>
                        ...
                        <p className="text-3xl font-bold text-white">{adminsCount}</p>
                    </div>
